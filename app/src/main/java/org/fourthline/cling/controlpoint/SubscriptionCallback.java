...
public abstract class SubscriptionCallback implements Runnable {
    ...
    public static String createDefaultFailureMessage(UpnpResponse upnpResponse, Exception exc) {
        if (upnpResponse == null) {
            return exc != null ? O000000OoooOoo0Ooo0OO00o00oOOo0O0ooooO0o.O000000OoooOoo0Ooo0OO00o00oOOo0O0ooooO0o("Subscription failed:  Exception occured: ", exc) : "Subscription failed:  No response received.";
        }
    ...
    private void establishLocalSubscription(LocalService localService) {
        ...
        try {
            ...
            try {
                ...
                log.log(Level.FINE, "Exception root cause: ", com.bumptech.glide.O000000OoooOoo0Ooo0OO00o00oOOo0O0ooooO0o.O00000OoOOoO0oOo0o0o0OoOOooOOo0o0O00000o(e));
