...
public enum AVTransportErrorCode {
    ...
    TRANSPORT_LOCKED(TypedValues.TransitionType.TYPE_INTERPOLATOR, "The transport is 'hold locked', e.g. with a keyboard lock"),
    WRITE_ERROR(TypedValues.TransitionType.TYPE_STAGGERED, "The media cannot be written"),
    MEDIA_PROTECTED(TypedValues.TransitionType.TYPE_TRANSITION_FLAGS, "The media is write-protected or is of a not writable type"),
