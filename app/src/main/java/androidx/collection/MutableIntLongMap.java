...
public final class MutableIntLongMap extends IntLongMap {
    ...
    private final void resizeStorage(int i) {
        ...
        while (i3 < i2) {
            if (((jArr[i3 >> 3] >> ((i3 & 7) << 3)) & 255) < 128) {
                ...
                int i11 = i10 >> 3;
                int i12 = (i10 & 7) << 3;
                jArr4[i11] = ((~(255 << i12)) & jArr4[i11]) | (j << i12);
    ...
    public /* synthetic */ MutableIntLongMap(int i, int i2, O000000o0ooOOOOoO0OO0000OOOoo0oo0OOOOoo0 o000000o0ooOOOOoO0OO0000OOOoo0oo0OOOOoo0) {
        this((i2 & 1) != 0 ? 6 : i);
    }
