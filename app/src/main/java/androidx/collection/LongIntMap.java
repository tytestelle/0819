...
public abstract class LongIntMap {
    ...
    public /* synthetic */ LongIntMap(O000000o0ooOOOOoO0OO0000OOOoo0oo0OOOOoo0 o000000o0ooOOOOoO0OO0000OOOoo0oo0OOOOoo0) {
        this();
    }
    ...
    /* JADX WARN: Code duplicated, block: B:28:0x0067 A[LOOP:0: B:14:0x0027->B:28:0x0067, LOOP_END] */
            ...
            while (true) {
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i4 = 0; i4 < i3; i4++) {
                        if ((255 & j) < 128) {
                            int i5 = (i << 3) + i4;
                            if (iArr[i5] != longIntMap.get(jArr[i5])) {
                                return false;
                            }
                            i2 = 8;
                        }
    ...
    public final void forEach(Function2<? super Long, ? super Integer, O000000oooOoo00ooo0O0000000o00O0Oooo0OOO> block) {
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i8 < i7) {
                        if ((j & 255) < 128) {
                            ...
                            sbO00000o00OOOOo0o00Oo00OooOoooOO0OOOoOoo0.append((CharSequence) function2.invoke(Long.valueOf(j2), Integer.valueOf(i10)));
                            i5++;
                        }
                        j >>= 8;
                        i8++;
  ...
  0x0090: PHI (r12v2 int) = (r12v1 int), (r12v3 int) binds: [B:6:0x0042, B:19:0x008e] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    public final String joinToString(CharSequence charSequence, CharSequence prefix, CharSequence postfix, int i, CharSequence charSequence2, Function2<? super Long, ? super Integer, ? extends CharSequence> function2) {
            ...
            if ((((~j) << 7) & j & (-9187201950435737472L)) == -9187201950435737472L) {
                ...
                while (i6 < i5) {
                    if ((j & 255) < 128) {
                        ...
                        sbO00000o00OOOOo0o00Oo00OooOoooOO0OOOoOoo0.append(function2.invoke(Long.valueOf(j2), Integer.valueOf(i8)));
                        i3++;
                    }
                    j >>= 8;
                    i6++;
            ...
            if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                while (i5 < i4) {
                    if ((j & 255) < 128) {
                        ...
                        sbO00000o00OOOOo0o00Oo00OooOoooOO0OOOoOoo0.append(function2.invoke(Long.valueOf(j2), Integer.valueOf(i7)));
                        i3++;
                    }
                    j >>= 8;
                    i5++;
            ...
            if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i4 = 0; i4 < i3; i4++) {
                    if ((j & 255) < 128) {
                        ...
                        sbO00000o00OOOOo0o00Oo00OooOoooOO0OOOoOoo0.append(function2.invoke(Long.valueOf(j2), Integer.valueOf(i6)));
                        i2++;
                    }
                    j >>= 8;
                }
            ...
            if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i4 = 0; i4 < i3; i4++) {
                    if ((j & 255) < 128) {
                        ...
                        sb.append(transform.invoke(Long.valueOf(j2), Integer.valueOf(i6)));
                        i2++;
                    }
                    j >>= 8;
                }
