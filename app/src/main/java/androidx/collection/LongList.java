...
public abstract class LongList {
    ...
    public /* synthetic */ LongList(int i, O000000o0ooOOOOoO0OO0000OOOoo0oo0OOOOoo0 o000000o0ooOOOOoO0OO0000OOOoo0oo0OOOOoo0) {
        this(i);
    }
    ...
    public final long elementAt(@IntRange(from = MediaDescriptionCompat.BT_FOLDER_TYPE_MIXED) int i) {
        if (i >= 0 && i < this._size) {
    ...
    public final long elementAtOrElse(@IntRange(from = MediaDescriptionCompat.BT_FOLDER_TYPE_MIXED) int i, Function1<? super Integer, Long> defaultValue) {
    ...
    public final void forEach(Function1<? super Long, O000000oooOoo00ooo0O0000000o00O0Oooo0OOO> block) {
    ...
    public final void forEachIndexed(Function2<? super Integer, ? super Long, O000000oooOoo00ooo0O0000000o00O0Oooo0OOO> block) {
        O000000ooO00OO0OoOO0OO0o00000oo000oo0oO0.O000000o0ooOOOOoO0OO0000OOOoo0oo0OOOOoo0(block, "block");
        long[] jArr = this.content;
        int i = this._size;
        for (int i2 = 0; i2 < i; i2++) {
    ...
    public final void forEachReversed(Function1<? super Long, O000000oooOoo00ooo0O0000000o00O0Oooo0OOO> block) {
        O000000ooO00OO0OoOO0OO0o00000oo000oo0oO0.O000000o0ooOOOOoO0OO0000OOOoo0oo0OOOOoo0(block, "block");
        long[] jArr = this.content;
        int i = this._size;
        while (true) {
    ...
    public final void forEachReversedIndexed(Function2<? super Integer, ? super Long, O000000oooOoo00ooo0O0000000o00O0Oooo0OOO> block) {
        O000000ooO00OO0OoOO0OO0o00000oo000oo0oO0.O000000o0ooOOOOoO0OO0000OOOoo0oo0OOOOoo0(block, "block");
        long[] jArr = this.content;
        int i = this._size;
        while (true) {
    ...
    public final long get(@IntRange(from = MediaDescriptionCompat.BT_FOLDER_TYPE_MIXED) int i) {
        if (i >= 0 && i < this._size) {
            return this.content[i];
        }
        StringBuilder sbO00000OOoOOoOOOo00oo0000O00ooo0oO00O00oO = O0000000Oo0o0O00ooOooooooO0000Oo0oO0O0oO.O00000OOoOOoOOOo00oo0000O00ooo0oO00O00oO(i, "Index ", " must be in 0..");
    ...
    public static /* synthetic */ String joinToString$default(LongList longList, CharSequence separator, CharSequence prefix, CharSequence postfix, int i, CharSequence charSequence, Function1 function1, int i2, Object obj) {
        if (obj == null) {
            ...
            for (int i4 = 0; i4 < i3; i4++) {
                ...
                sbO00000OoOOoOoOOoo0oOoOoOOO0OooOoO0oOo0o0.append((CharSequence) function1.invoke(Long.valueOf(j)));
            }
    ...
    public final String joinToString(CharSequence separator, CharSequence prefix, CharSequence charSequence, int i, CharSequence charSequence2) {
        ...
        for (int i3 = 0; i3 < i2; i3++) {
            ...
            sbO00000OoOOoO0oOo0o0o0OoOOooOOo0o0O00000o.append(j);
        }
    ...
    public final String joinToString(CharSequence separator, CharSequence prefix, CharSequence postfix, int i, CharSequence charSequence, Function1<? super Long, ? extends CharSequence> function1) {
        ...
        for (int i3 = 0; i3 < i2; i3++) {
            ...
            sbO00000OoOOoOoOOoo0oOoOoOOO0OooOoO0oOo0o0.append(function1.invoke(Long.valueOf(j)));
        }
        sbO00000OoOOoOoOOoo0oOoOoOOO0OooOoO0oOo0o0.append(postfix);
        String string2 = sbO00000OoOOoOoOOoo0oOoOoOOO0OooOoO0oOo0o0.toString();
        O000000ooO00OO0OoOO0OO0o00000oo000oo0oO0.O000000o0o00OOO0OoOo00oo0oo0ooo0o0Oo0OOo(string2, "StringBuilder().apply(builderAction).toString()");
