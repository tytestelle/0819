...
public abstract class FloatSet {
    ...
    public /* synthetic */ FloatSet(O000000o0ooOOOOoO0OO0000OOOoo0oo0OOOOoo0 o000000o0ooOOOOoO0OO0000OOOoo0oo0OOOOoo0) {
        this();
    }
            ...
            while (true) {
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i4 = 0; i4 < i3; i4++) {
                        if ((255 & j) < 128) {
                            iFloatToIntBits = Float.floatToIntBits(fArr[(i2 << 3) + i4]) + iFloatToIntBits;
                        }
                        j >>= 8;
                    }
                    if (i3 != 8) {
