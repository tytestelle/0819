...
public abstract class FloatObjectMap<V> {
    ...
    public /* synthetic */ FloatObjectMap(O000000o0ooOOOOoO0OO0000OOOoo0oo0OOOOoo0 o000000o0ooOOOOoO0OO0000OOOoo0oo0OOOOoo0) {
        this();
    }
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) == -9187201950435737472L) {
                    ...
                    for (int i3 = 0; i3 < i2; i3++) {
                        if ((255 & j) < 128) {
                            ...
                            } else if (!obj2.equals(floatObjectMap.get(f))) {
                                return false;
                            }
                        }
                        j >>= 8;
    ...
    public final void forEach(Function2<? super Float, ? super V, O000000oooOoo00ooo0O0000000o00O0Oooo0OOO> block) {
  ...
  0x006e: PHI (r8v2 int) = (r8v1 int), (r8v3 int) binds: [B:10:0x0030, B:22:0x006c] A[DONT_GENERATE, DONT_INLINE]] */
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i8 < i7) {
                        if ((j & 255) < 128) {
                            ...
                            sbO00000o00OOOOo0o00Oo00OooOoooOO0OOOoOoo0.append((CharSequence) function2.invoke(Float.valueOf(f), obj2));
                            i5++;
                        }
                        j >>= 8;
                        i8++;
    ...
    public final String joinToString(CharSequence charSequence, CharSequence prefix, CharSequence postfix, int i, CharSequence charSequence2, Function2<? super Float, ? super V, ? extends CharSequence> function2) {
        float[] fArr;
            ...
            if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                while (i6 < i5) {
                    if ((j & 255) < 128) {
                        ...
                        sbO00000o00OOOOo0o00Oo00OooOoooOO0OOOoOoo0.append(function2.invoke(Float.valueOf(f), obj));
                        i3++;
                    }
                    j >>= 8;
                    i6++;
  ...
  0x0086: PHI (r11v2 int) = (r11v1 int), (r11v3 int) binds: [B:6:0x003a, B:19:0x0084] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    public final String joinToString(CharSequence separator, CharSequence prefix, CharSequence charSequence, int i, Function2<? super Float, ? super V, ? extends CharSequence> function2) {
        O000000ooO00OO0OoOO0OO0o00000oo000oo0oO0.O000000o0ooOOOOoO0OO0000OOOoo0oo0OOOOoo0(separator, "separator");
        O000000ooO00OO0OoOO0OO0o00000oo000oo0oO0.O000000o0ooOOOOoO0OO0000OOOoo0oo0OOOOoo0(prefix, "prefix");
