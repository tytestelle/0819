...
public abstract class IntObjectMap<V> {
    ...
    public /* synthetic */ IntObjectMap(O000000o0ooOOOOoO0OO0000OOOoo0oo0OOOOoo0 o000000o0ooOOOOoO0OO0000OOOoo0oo0OOOOoo0) {
        this();
    }
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) == -9187201950435737472L) {
                    ...
                    for (int i3 = 0; i3 < i2; i3++) {
                        if ((255 & j) < 128) {
                            ...
                            } else if (!obj2.equals(intObjectMap.get(i5))) {
                                return false;
                            }
                        }
                        j >>= 8;
    ...
    public final void forEach(Function2<? super Integer, ? super V, O000000oooOoo00ooo0O0000000o00O0Oooo0OOO> block) {
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i8 < i7) {
                        if ((j & 255) < 128) {
                            ...
                            sbO00000o00OOOOo0o00Oo00OooOoooOO0OOOoOoo0.append((CharSequence) function2.invoke(Integer.valueOf(i10), obj2));
                            i5++;
                        }
                        j >>= 8;
                        i8++;
            ...
            if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                while (i6 < i5) {
                    if ((j & 255) < 128) {
                        ...
                        sbO00000o00OOOOo0o00Oo00OooOoooOO0OOOoOoo0.append(function2.invoke(Integer.valueOf(i8), obj));
                        i3++;
                    }
                    j >>= 8;
                    i6++;
            ...
            if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i5 = 0; i5 < i4; i5++) {
                    if ((j & 255) < 128) {
                        ...
                        sbO00000o00OOOOo0o00Oo00OooOoooOO0OOOoOoo0.append(function2.invoke(Integer.valueOf(i7), obj));
                        i3++;
                    }
                    j >>= 8;
                }
            ...
            if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i4 = 0; i4 < i3; i4++) {
                    if ((j & 255) < 128) {
                        ...
                        sbO00000o00OOOOo0o00Oo00OooOoooOO0OOOoOoo0.append(function2.invoke(Integer.valueOf(i6), obj));
                        i2++;
                    }
                    j >>= 8;
                }
            ...
            if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i4 = 0; i4 < i3; i4++) {
                    if ((j & 255) < 128) {
                        ...
                        sb.append(transform.invoke(Integer.valueOf(i6), obj));
                        i2++;
                    }
                    j >>= 8;
                }
