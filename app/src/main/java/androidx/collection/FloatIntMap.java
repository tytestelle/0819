...
public abstract class FloatIntMap {
    ...
    public /* synthetic */ FloatIntMap(O000000o0ooOOOOoO0OO0000OOOoo0oo0OOOOoo0 o000000o0ooOOOOoO0OO0000OOOoo0oo0OOOOoo0) {
        this();
    }
    ...
    public final void forEach(Function2<? super Float, ? super Integer, O000000oooOoo00ooo0O0000000o00O0Oooo0OOO> block) {
    ...
    public final void forEachKey(Function1<? super Float, O000000oooOoo00ooo0O0000000o00O0Oooo0OOO> block) {
        O000000ooO00OO0OoOO0OO0o00000oo000oo0oO0.O000000o0ooOOOOoO0OO0000OOOoo0oo0OOOOoo0(block, "block");
        float[] fArr = this.keys;
        long[] jArr = this.metadata;
        int length = jArr.length - 2;
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i8 < i7) {
                        if ((j & 255) < 128) {
                            ...
                            sbO00000o00OOOOo0o00Oo00OooOoooOO0OOOoOoo0.append((CharSequence) function2.invoke(Float.valueOf(f), Integer.valueOf(i10)));
                            i5++;
                        }
                        j >>= 8;
                        i8++;
  ...
  0x0090: PHI (r12v2 int) = (r12v1 int), (r12v3 int) binds: [B:6:0x0042, B:19:0x008e] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    public final String joinToString(CharSequence charSequence, CharSequence prefix, CharSequence postfix, int i, CharSequence charSequence2, Function2<? super Float, ? super Integer, ? extends CharSequence> function2) {
            ...
            if ((((~j) << 7) & j & (-9187201950435737472L)) == -9187201950435737472L) {
                ...
                while (i6 < i5) {
                    if ((j & 255) < 128) {
                        ...
                        sbO00000o00OOOOo0o00Oo00OooOoooOO0OOOoOoo0.append(function2.invoke(Float.valueOf(f), Integer.valueOf(i8)));
                        i3++;
                    }
                    j >>= 8;
                    i6++;
            ...
            if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                while (i5 < i4) {
                    if ((j & 255) < 128) {
                        ...
                        sbO00000o00OOOOo0o00Oo00OooOoooOO0OOOoOoo0.append(function2.invoke(Float.valueOf(f), Integer.valueOf(i7)));
                        i3++;
                    }
                    j >>= 8;
                    i5++;
            ...
            if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i4 = 0; i4 < i3; i4++) {
                    if ((j & 255) < 128) {
                        ...
                        sbO00000o00OOOOo0o00Oo00OooOoooOO0OOOoOoo0.append(function2.invoke(Float.valueOf(f), Integer.valueOf(i6)));
                        i2++;
                    }
                    j >>= 8;
                }
