...
public abstract class FloatFloatMap {
    ...
    public /* synthetic */ FloatFloatMap(O000000o0ooOOOOoO0OO0000OOOoo0oo0OOOOoo0 o000000o0ooOOOOoO0OO0000OOOoo0oo0OOOOoo0) {
        this();
    }
    ...
    public final void forEach(Function2<? super Float, ? super Float, O000000oooOoo00ooo0O0000000o00O0Oooo0OOO> block) {
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i8 < i7) {
                        if ((j & 255) < 128) {
                            ...
                            sbO00000o00OOOOo0o00Oo00OooOoooOO0OOOoOoo0.append((CharSequence) function2.invoke(Float.valueOf(f), Float.valueOf(f2)));
                            i5++;
                        }
                        j >>= 8;
                        i8++;
            ...
            if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                while (i5 < i4) {
                    if ((j & 255) < 128) {
                        ...
                        sbO00000OoOOoO0oOo0o0o0OoOOooOOo0o0O00000o.append(f2);
                        i3++;
                    }
                    j >>= 8;
                    i5++;
  ...
  0x0090: PHI (r12v2 int) = (r12v1 int), (r12v3 int) binds: [B:6:0x0042, B:19:0x008e] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    public final String joinToString(CharSequence charSequence, CharSequence prefix, CharSequence postfix, int i, CharSequence charSequence2, Function2<? super Float, ? super Float, ? extends CharSequence> function2) {
            ...
            if ((((~j) << 7) & j & (-9187201950435737472L)) == -9187201950435737472L) {
                ...
                while (i6 < i5) {
                    if ((j & 255) < 128) {
                        ...
                        sbO00000o00OOOOo0o00Oo00OooOoooOO0OOOoOoo0.append(function2.invoke(Float.valueOf(f), Float.valueOf(f2)));
                        i3++;
                    }
                    j >>= 8;
                    i6++;
