...
public abstract class ObjectFloatMap<K> {
    ...
    public /* synthetic */ ObjectFloatMap(O000000o0ooOOOOoO0OO0000OOOoo0oo0OOOOoo0 o000000o0ooOOOOoO0OO0000OOOoo0oo0OOOOoo0) {
        this();
    }
    ...
    public final void forEach(Function2<? super K, ? super Float, O000000oooOoo00ooo0O0000000o00O0Oooo0OOO> block) {
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i8 < i7) {
                        if ((j & 255) < 128) {
                            ...
                            sbO00000o00OOOOo0o00Oo00OooOoooOO0OOOoOoo0.append((CharSequence) function2.invoke(obj2, Float.valueOf(f)));
                            i5++;
                        }
                        j >>= 8;
                        i8++;
            ...
            if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                while (i6 < i5) {
                    if ((j & 255) < 128) {
                        ...
                        sbO00000o00OOOOo0o00Oo00OooOoooOO0OOOoOoo0.append(function2.invoke(obj, Float.valueOf(f)));
                        i3++;
                    }
                    j >>= 8;
                    i6++;
