...
class FastScroller extends RecyclerView.ItemDecoration implements RecyclerView.OnItemTouchListener {
    ...
    public FastScroller(RecyclerView recyclerView, StateListDrawable stateListDrawable, Drawable drawable, StateListDrawable stateListDrawable2, Drawable drawable2, int i, int i2, int i3) {
        ...
        this.mHideRunnable = new Runnable() { // from class: androidx.recyclerview.widget.FastScroller.1
            ...
            public void run() {
                FastScroller.this.hide(TbsListener.ErrorCode.INFO_CODE_MINIQB);
            }
        };
    ...
    public void updateScrollPosition(int i, int i2) {
        ...
        if (z2) {
            float f = i3;
            this.mVerticalThumbCenterY = (int) ((((f / 2.0f) + i2) * f) / iComputeVerticalScrollRange);
            this.mVerticalThumbHeight = Math.min(i3, (i3 * i3) / iComputeVerticalScrollRange);
        }
        if (this.mNeedHorizontalScrollbar) {
            float f2 = i4;
            this.mHorizontalThumbCenterX = (int) ((((f2 / 2.0f) + i) * f2) / iComputeHorizontalScrollRange);
