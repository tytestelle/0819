...
public class DiffUtil {
    ...
    public static class DiffResult {
        ...
        public int convertNewPositionToOld(@IntRange(from = MediaDescriptionCompat.BT_FOLDER_TYPE_MIXED) int i) {
            if (i < 0 || i >= this.mNewListSize) {
                StringBuilder sbO00000OOoOOoOOOo00oo0000O00ooo0oO00O00oO = O0000000Oo0o0O00ooOooooooO0000Oo0oO0O0oO.O00000OOoOOoOOOo00oo0000O00ooo0oO00O00oO(i, "Index out of bounds - passed position = ", ", new list size = ");
                sbO00000OOoOOoOOOo00oo0000O00ooo0oO00O00oO.append(this.mNewListSize);
        ...
        public int convertOldPositionToNew(@IntRange(from = MediaDescriptionCompat.BT_FOLDER_TYPE_MIXED) int i) {
            if (i < 0 || i >= this.mOldListSize) {
                StringBuilder sbO00000OOoOOoOOOo00oo0000O00ooo0oO00O00oO = O0000000Oo0o0O00ooOooooooO0000Oo0oO0O0oO.O00000OOoOOoOOOo00oo0000O00ooo0oO00O00oO(i, "Index out of bounds - passed position = ", ", old list size = ");
                sbO00000OOoOOoOOOo00oo0000O00ooo0oO00O00oO.append(this.mOldListSize);
                throw new IndexOutOfBoundsException(sbO00000OOoOOoOOOo00oo0000O00ooo0oO00O00oO.toString());
            }
    ...
    private static Snake forward(Range range, Callback callback, CenteredArray centeredArray, CenteredArray centeredArray2, int i) {
        ...
        for (int i6 = i5; i6 <= i; i6 += 2) {
            ...
            int i7 = ((i3 - range.oldListStart) + range.newListStart) - i6;
            int i8 = (i == 0 || i3 != i2) ? i7 : i7 - 1;
