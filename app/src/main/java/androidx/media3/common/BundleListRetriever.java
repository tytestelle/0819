...
public final class BundleListRetriever extends Binder {
    ...
    private final O000O0000OOoo0O00OoO00O0o0OO00OOOOoOoo0O list;
    ...
    public BundleListRetriever(List<Bundle> list) {
        this.list = O000O0000OOoo0O00OoO00O0o0OO00OOOOoOoo0O.copyOf((Collection) list);
    }

    public static O000O0000OOoo0O00OoO00O0o0OO00OOOOoOoo0O getList(IBinder iBinder) {
        return iBinder instanceof BundleListRetriever ? ((BundleListRetriever) iBinder).list : getListFromRemoteBinder(iBinder);
    }

    @VisibleForTesting
    public static O000O0000OOoo0O00OoO00O0o0OO00OOOOoOoo0O getListFromRemoteBinder(IBinder iBinder) {
        int i;
            ...
            try {
                ...
                try {
                    ...
                    while (true) {
                        ...
                        if (i == 1) {
                            o0000ooOOOoO00Oo0O00ooOO0OOOOOO0OOOoO0oOBuilder.O000000o0o00OOO0OoOo00oo0oo0ooo0o0Oo0OOo((Bundle) Assertions.checkNotNull(parcelObtain2.readBundle()));
                            i3++;
                        }
                    }
