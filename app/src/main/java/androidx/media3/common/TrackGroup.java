...
public final class TrackGroup {
    ...
    public static TrackGroup fromBundle(Bundle bundle) {
        ...
        return new TrackGroup(bundle.getString(FIELD_ID, ""), (Format[]) (parcelableArrayList == null ? O000O0000OOoo0O00OoO00O0o0OO00OOOOoOoo0O.of() : BundleCollectionUtil.fromBundleList(new O000000o0ooOOOOoO0OO0000OOOoo0oo0OOOOoo0(9), parcelableArrayList)).toArray(new Format[0]));
    }
    ...
    public int hashCode() {
        if (this.hashCode == 0) {
            this.hashCode = Arrays.hashCode(this.formats) + O000000OoooOoo0Ooo0OO00o00oOOo0O0ooooO0o.O0000000Oo0o0O00ooOooooooO0000Oo0oO0O0oO(527, 31, this.id);
        }
