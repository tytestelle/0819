...
public class PlaybackException extends Exception {
    ...
    */
    public boolean errorInfoEquals(@androidx.annotation.Nullable androidx.media3.common.PlaybackException r7) {
        ...
        if (r7 == null || this.errorCode != r7.errorCode) return false;
        if (!java.util.Objects.equals(getMessage(), r7.getMessage())) return false;
        if (this.timestampMs != r7.timestampMs) return false;
        return java.util.Objects.equals(this.extras, r7.extras);
    }
