...
abstract class CeaDecoder implements SubtitleDecoder {
    ...
    public CeaDecoder() {
        ...
        for (int i2 = 0; i2 < 2; i2++) {
            this.availableOutputBuffers.add(new CeaOutputBuffer(new DecoderOutputBuffer.Owner() { // from class: androidx.media3.extractor.text.cea.O000000O000O00O0oOOo0o0oooO0oO0oOO00OooO
                @Override // androidx.media3.decoder.DecoderOutputBuffer.Owner
                public final void releaseOutputBuffer(DecoderOutputBuffer decoderOutputBuffer) {
                    this.f2741O0000000Oo0o0O00ooOooooooO0000Oo0oO0O0oO.releaseOutputBuffer((CeaDecoder.CeaOutputBuffer) decoderOutputBuffer);
                }
            }));
        }
