...
public final class DvbParser implements SubtitleParser {
    ...
    /* JADX WARN: Code duplicated, block: B:26:0x0063 A[ADDED_TO_REGION] */
    /* JADX WARN: Code duplicated, block: B:28:0x0067  */
    /* JADX WARN: Code duplicated, block: B:33:0x0083 A[LOOP:0: B:3:0x0009->B:33:0x0083, LOOP_END] */
    ...
    private CuesWithTiming parse(ParsableBitArray parsableBitArray) {
        ...
        if (pageComposition == null) {
            return new CuesWithTiming(O000O0000OOoo0O00OoO00O0o0OO00OOOOoOoo0O.of(), C.TIME_UNSET, C.TIME_UNSET);
        }
