...
public final class Tx3gParser implements SubtitleParser {
    ...
    private void applyStyleRecord(ParsableByteArray parsableByteArray, SpannableStringBuilder spannableStringBuilder) {
        ...
        if (unsignedShort2 > spannableStringBuilder.length()) {
            StringBuilder sbO00000OOoOOoOOOo00oo0000O00ooo0oO00O00oO = O0000000Oo0o0O00ooOooooooO0000Oo0oO0O0oO.O00000OOoOOoOOOo00oo0000O00ooo0oO00O00oO(unsignedShort2, "Truncating styl end (", ") to cueText.length() (");
            sbO00000OOoOOoOOOo00oo0000O00ooo0oO00O00oO.append(spannableStringBuilder.length());
            sbO00000OOoOOoOOOo00oo0000O00ooo0oO00O00oO.append(").");
            Log.w(TAG, sbO00000OOoOOoOOOo00oo0000O00ooo0oO00O00oO.toString());
    ...
    public void parse(byte[] bArr, int i, int i2, SubtitleParser.OutputOptions outputOptions, Consumer<CuesWithTiming> consumer) {
        ...
        if (subtitleText.isEmpty()) {
            consumer.accept(new CuesWithTiming(O000O0000OOoo0O00OoO00O0o0OO00OOOOoOoo0O.of(), C.TIME_UNSET, C.TIME_UNSET));
            return;
        }
        ...
        consumer.accept(new CuesWithTiming(O000O0000OOoo0O00OoO00O0o0OO00OOOOoOoo0O.of(new Cue.Builder().setText(spannableStringBuilder).setLine(fConstrainValue, 0).setLineAnchor(0).build()), C.TIME_UNSET, C.TIME_UNSET));
    }
}
