...
public class TrackSelectionView extends LinearLayout {
    ...
    private void onTrackViewClicked(View view) {
        ...
        if (trackSelectionOverride == null) {
            ...
            this.overrides.put(mediaTrackGroup, new TrackSelectionOverride(mediaTrackGroup, O000O0000OOoo0O00OoO00O0o0OO00OOOOoOoo0O.of(Integer.valueOf(i))));
            return;
        }
    ...
    public void init(List<Tracks.Group> list, boolean z, Map<TrackGroup, TrackSelectionOverride> map, @Nullable final Comparator<Format> comparator, @Nullable TrackSelectionListener trackSelectionListener) {
        this.isDisabled = z;
        this.trackInfoComparator = comparator == null ? null : new Comparator() { // from class: androidx.media3.ui.O00000OoOOoOoOOoo0oOoOoOOO0OooOoO0oOo0o0
