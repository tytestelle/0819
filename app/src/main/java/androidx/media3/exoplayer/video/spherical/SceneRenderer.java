...
final class SceneRenderer implements VideoFrameMetadataListener, CameraMotionListener {
    ...
    public SurfaceTexture init() {
        ...
        surfaceTexture.setOnFrameAvailableListener(new SurfaceTexture.OnFrameAvailableListener() { // from class: androidx.media3.exoplayer.video.spherical.O0000000Oo0o0O00ooOooooooO0000Oo0oO0O0oO
            @Override // android.graphics.SurfaceTexture.OnFrameAvailableListener
            public final void onFrameAvailable(SurfaceTexture surfaceTexture2) {
                this.f2731O0000000Oo0o0O00ooOooooooO0000Oo0oO0O0oO.lambda$init$0(surfaceTexture2);
            }
        });
