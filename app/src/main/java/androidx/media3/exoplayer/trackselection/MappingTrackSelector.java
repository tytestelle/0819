    ...
    private static int findRenderer(RendererCapabilities[] rendererCapabilitiesArr, TrackGroup trackGroup, int[] iArr, boolean z) {
        ...
        for (int i2 = 0; i2 < rendererCapabilitiesArr.length; i2++) {
            ...
            for (int i3 = 0; i3 < trackGroup.length; i3++) {
                iMax = Math.max(iMax, O0000OO0oooooo0oo0Oo0OOOoOO0o0OooooO0000.O000000ooo0oOOoOo00ooOOOOooOoooOoo0oo00O(rendererCapabilities.supportsFormat(trackGroup.getFormat(i3))));
            }
    ...
    public static final class MappedTrackInfo {
        ...
        public int getRendererSupport(int i) {
            ...
            for (int[] iArr : this.rendererFormatSupports[i]) {
                for (int i2 : iArr) {
                    int iO000000ooo0oOOoOo00ooOOOOooOoooOoo0oo00O = O0000OO0oooooo0oo0Oo0OOOoOO0o0OooooO0000.O000000ooo0oOOoOo00ooOOOOooOoooOoo0oo00O(i2);
                    int i3 = 1;
                    if (iO000000ooo0oOOoOo00ooOOOOooOoooOoo0oo00O != 0 && iO000000ooo0oOOoOo00ooOOOOooOoooOoo0oo00O != 1 && iO000000ooo0oOOoOo00ooOOOOooOoooOoo0oo00O != 2) {
                        if (iO000000ooo0oOOoOo00ooOOOOooOoooOoo0oo00O != 3) {
                            if (iO000000ooo0oOOoOo00ooOOOOooOoooOoo0oo00O == 4) {
                                return 3;
                            }
        ...
        public int getTrackSupport(int i, int i2, int i3) {
            return O0000OO0oooooo0oo0Oo0OOOoOO0o0OooooO0000.O000000ooo0oOOoOo00ooOOOOooOoooOoo0oo00O(getCapabilities(i, i2, i3));
        }
        ...
        public int getAdaptiveSupport(int i, int i2, int[] iArr) {
            ...
            while (i3 < iArr.length) {
                ...
                iMin = Math.min(iMin, O0000OO0oooooo0oo0Oo0OOOoOO0o0OooooO0000.O000000oOoo00OOooOoOOoO000Oo0OoO0o0OOooo(this.rendererFormatSupports[i][i2][i3]));
                i3++;
                i4 = i5;
            }
