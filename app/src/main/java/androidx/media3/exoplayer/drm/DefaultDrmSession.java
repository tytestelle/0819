...
class DefaultDrmSession implements DrmSession {
    ...
    private void doLicense(boolean z) {
        ...
        if (this.state == 4 || restoreKeys()) {
            ...
            if (licenseDurationRemainingSec <= 0) {
                ...
                this.state = 4;
                dispatchEvent(new O0000000Oo0o0O00ooOooooooO0000Oo0oO0O0oO(3));
            }
        }
    }
    ...
    private void onError(final Throwable th, int i) {
        ...
        if (th instanceof Exception) {
            dispatchEvent(new Consumer() { // from class: androidx.media3.exoplayer.drm.O000000O000O00O0oOOo0o0oooO0oO0oOO00OooO
        ...
        if (obj == this.currentKeyRequest && isOpen()) {
            ...
            try {
                ...
                if (this.mode == 3) {
                    ...
                    dispatchEvent(new O0000000Oo0o0O00ooOooooooO0000Oo0oO0O0oO(1));
                    return;
                }
                ...
                this.state = 4;
                dispatchEvent(new O0000000Oo0o0O00ooOooooooO0000Oo0oO0O0oO(2));
            } catch (Exception e) {
                e = e;
                onKeysError(e, true);
    ...
    private boolean openInternal() {
        ...
        try {
            ...
            this.state = 3;
            dispatchEvent(new O0000000Oo0o0O00ooOooooooO0000Oo0oO0O0oO(0));
            Assertions.checkNotNull(this.sessionId);
            return true;
