...
final class AsynchronousMediaCodecCallback extends MediaCodec.Callback {
    ...
    public void flush() {
        synchronized (this.lock) {
            ...
            ((Handler) Util.castNonNull(this.handler)).post(new Runnable() { // from class: androidx.media3.exoplayer.mediacodec.O000000OoooOoo0Ooo0OO00o00oOOo0O0ooooO0o
                @Override // java.lang.Runnable
                public final void run() {
                    this.f2590O0000000Oo0o0O00ooOooooooO0000Oo0oO0O0oO.onFlushCompleted();
                }
            });
        }
    }
