...
public class SlidingPercentile {
    ...
    static {
        final int i = 0;
        INDEX_COMPARATOR = new Comparator() { // from class: androidx.media3.exoplayer.upstream.O000000ooOO0oOoOo00OoooOOo0OO00o0000o0oO
        ...
        final int i2 = 1;
        VALUE_COMPARATOR = new Comparator() { // from class: androidx.media3.exoplayer.upstream.O000000ooOO0oOoOo00OoooOOo0OO00o0000o0oO
            @Override // java.util.Comparator
            public final int compare(Object obj, Object obj2) {
                SlidingPercentile.Sample sample = (SlidingPercentile.Sample) obj;
                SlidingPercentile.Sample sample2 = (SlidingPercentile.Sample) obj2;
