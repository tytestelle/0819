...
public final class DefaultBandwidthMeter implements BandwidthMeter, TransferListener {
    ...
    public static long getInitialBitrateEstimatesForCountry(@Nullable String str, int i) {
        int[] initialBitrateCountryGroupAssignment = getInitialBitrateCountryGroupAssignment(O0000O0o00oO0oO0OOo0oOOOO0oOO0ooo00o000o.O000000OoooOoo0Ooo0OO00o00oOOo0O0ooooO0o.O00000OOoOOO00O00o0ooooooooO000ooooO0000(str));
        if (i != 2) {
            if (i == 3) {
    ...
    public static final class Builder {
        ...
        public Builder setInitialBitrateEstimate(String str) {
            ...
            for (Integer num : this.initialBitrateEstimates.keySet()) {
                setInitialBitrateEstimate(num.intValue(), DefaultBandwidthMeter.getInitialBitrateEstimatesForCountry(strO0000O000OOOoo0o00O0000O00OoOo0000ooOOo0, num.intValue()));
            }
            return this;
        }
    }
    ...
    private DefaultBandwidthMeter(@Nullable Context context, Map<Integer, Long> map, int i, Clock clock, boolean z) {
        ...
        networkTypeObserver.register(new O000000oO0OOo0O00OoooOOoOO0o0o0000O0OOoO(this, 0), BackgroundExecutor.get());
    }
}
