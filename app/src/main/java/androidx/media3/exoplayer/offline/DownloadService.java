    ...
    public static final class DownloadManagerHelper implements DownloadManager.Listener {
        ...
        public void attachService(DownloadService downloadService) {
            ...
            if (this.downloadManager.isInitialized()) {
                Util.createHandlerForCurrentOrMainLooper().postAtFrontOfQueue(new O000000oOoo00OOooOoOOoO000Oo0OoO0o0OOooo(this, downloadService, 0));
            }
        }
        ...
        public final /* synthetic */ void onDownloadsPausedChanged(DownloadManager downloadManager, boolean z) {
            O000000oOo0oOOOOoO0ooooo0oOOoO00Oo0Oo000.O000000OoooOoo0Ooo0OO00o00oOOo0O0ooooO0o(this, downloadManager, z);
        }
    ...
    public final class ForegroundNotificationUpdater {
        ...
        public void update() {
            ...
            if (this.periodicUpdatesStarted) {
                ...
                this.handler.postDelayed(new Runnable() { // from class: androidx.media3.exoplayer.offline.O000000ooO00OO0OoOO0OO0o00000oo000oo0oO0
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f2603O0000000Oo0o0O00ooOooooooO0000Oo0oO0O0oO.update();
                    }
                }, this.updateInterval);
            }
        }
