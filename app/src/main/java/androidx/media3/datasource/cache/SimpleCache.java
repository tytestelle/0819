...
public final class SimpleCache implements Cache {
    ...
    private static long createUid(File file) throws IOException {
        ...
        File file2 = new File(file, O000000oOo0oOOOOoO0ooooo0oOOoO00Oo0Oo000.O0000000Oo0o0O00ooOooooooO0000Oo0oO0O0oO.O000000ooOO0oOoOo00OoooOOo0OO00o0000o0oO(Long.toString(jAbs, 16), UID_FILE_SUFFIX));
    ...
    private void removeSpanInternal(CacheSpan cacheSpan) {
        ...
        if (this.fileIndex != null) {
            ...
            try {
                ...
                androidx.media3.common.O000000OoooOoo0Ooo0OO00o00oOOo0O0ooooO0o.O000000oOo0oOOOOoO0ooooo0oOOoO00Oo0Oo000("Failed to remove file index entry for: ", name, TAG);
            }
        }
    ...
    public synchronized void commitFile(File file, long j) {
        ...
        if (file.exists()) {
            ...
            if (jO0000000Oo0o0O00ooOooooooO0000Oo0oO0O0oO != -1) {
                Assertions.checkState(simpleCacheSpan.position + simpleCacheSpan.length <= jO0000000Oo0o0O00ooOooooooO0000Oo0oO0O0oO);
            }
            if (this.fileIndex == null) {
