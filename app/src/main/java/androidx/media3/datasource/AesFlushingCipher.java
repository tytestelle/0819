...
public final class AesFlushingCipher {
    ...
    public AesFlushingCipher(int i, byte[] bArr, long j, long j2) {
        try {
            ...
            cipher.init(i, new SecretKeySpec(bArr, Util.splitAtFirst(cipher.getAlgorithm(), ServiceReference.DELIMITER)[0]), new IvParameterSpec(getInitializationVector(j, j2 / ((long) blockSize))));
            if (i2 != 0) {
