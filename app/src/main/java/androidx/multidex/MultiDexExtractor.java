...
final class MultiDexExtractor implements Closeable {
    ...
    private static void extract(ZipFile zipFile, ZipEntry zipEntry, File file, String str) throws IOException {
        ...
        File fileCreateTempFile = File.createTempFile(O0000000Oo0o0O00ooOooooooO0000Oo0oO0O0oO.O00000oo0O0Oo0OO0oOoOoOOOOoOOoo0oOoOOOoO("tmp-", str), EXTRACTED_SUFFIX, file.getParentFile());
    ...
    private static void putStoredApkInfo(Context context, String str, long j, long j2, List<ExtractedDex> list) {
        ...
        editorEdit.putLong(O0000000Oo0o0O00ooOooooooO0000Oo0oO0O0oO.O00000OO000O000Oo0000oOOo0OO0oOoo0o0oo00(new StringBuilder(), str, KEY_CRC), j2);
