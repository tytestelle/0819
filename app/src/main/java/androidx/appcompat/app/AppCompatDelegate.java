...
public abstract class AppCompatDelegate {
    ...
    public static class SerialExecutor implements Executor {
        ...
        public void execute(final Runnable runnable) {
            synchronized (this.mLock) {
                try {
                    this.mTasks.add(new Runnable() { // from class: androidx.appcompat.app.O000000O000O00O0oOOo0o0oooO0oO0oOO00OooO
                        @Override // java.lang.Runnable
                        public final void run() {
                            this.f2132O0000000Oo0o0O00ooOooooooO0000Oo0oO0O0oO.lambda$execute$0(runnable);
                        }
                    });
    ...
    public static void syncRequestedAndStoredLocales(Context context) {
        if (isAutoStorageOptedIn(context)) {
            if (Build.VERSION.SDK_INT >= 33) {
                ...
                sSerialExecutorForLocalesStorage.execute(new O0000000Oo0o0O00ooOooooooO0000Oo0oO0O0oO(context, 0));
                return;
            }
    ...
    public void asyncExecuteSyncRequestedAndStoredLocales(Context context) {
        sSerialExecutorForLocalesStorage.execute(new O0000000Oo0o0O00ooOooooooO0000Oo0oO0O0oO(context, 1));
    }
