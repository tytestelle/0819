...
public class AppCompatDialog extends ComponentDialog implements AppCompatCallback {
    ...
    public AppCompatDialog(@NonNull Context context, int i) {
        ...
        this.mKeyDispatcher = new KeyEventDispatcher.Component() { // from class: androidx.appcompat.app.O000000o0o00OOO0OoOo00oo0oo0ooo0o0Oo0OOo
            @Override // androidx.core.view.KeyEventDispatcher.Component
            public final boolean superDispatchKeyEvent(KeyEvent keyEvent) {
                return this.f2135O0000000Oo0o0O00ooOooooooO0000Oo0oO0O0oO.superDispatchKeyEvent(keyEvent);
            }
        };
