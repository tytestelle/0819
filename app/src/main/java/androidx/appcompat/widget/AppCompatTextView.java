...
public class AppCompatTextView extends TextView implements TintableBackgroundView, TintableCompoundDrawablesView, AutoSizeableTextView, EmojiCompatConfigurationView {
    ...
    @Override // android.widget.TextView
    public void setFirstBaselineToTopHeight(@IntRange(from = MediaDescriptionCompat.BT_FOLDER_TYPE_MIXED) @Px int i) {
    ...
    @Override // android.widget.TextView
    public void setLastBaselineToBottomHeight(@IntRange(from = MediaDescriptionCompat.BT_FOLDER_TYPE_MIXED) @Px int i) {
        if (Build.VERSION.SDK_INT >= 28) {
    ...
    @Override // android.widget.TextView
    public void setLineHeight(@IntRange(from = MediaDescriptionCompat.BT_FOLDER_TYPE_MIXED) @Px int i) {
