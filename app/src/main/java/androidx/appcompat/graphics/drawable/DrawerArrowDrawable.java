...
public class DrawerArrowDrawable extends Drawable {
    ...
    private static float lerp(float f, float f2, float f3) {
        return O0000000Oo0o0O00ooOooooooO0000Oo0oO0O0oO.O0000000Oo0o0O00ooOooooooO0000Oo0oO0O0oO(f2, f, f3, f);
    }
    ...
    public void draw(@NonNull Canvas canvas) {
        ...
        canvas.translate(bounds.centerX(), (strokeWidth * 1.5f) + f3 + ((((int) (fHeight - (2.0f * f3))) / 4) * 2));
        if (this.mSpin) {
