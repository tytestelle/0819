...
public final class ProfileVerifier {
    ...
    @NonNull
    public static O0000O0OOoo00o0Oo0ooOOo0o0oOooooOOO00000 getCompilationStatusAsync() {
        return sFuture;
    }
                ...
                try {
                    ...
                    if (fromFile == null || !fromFile.equals(cache)) {
                        try {
                            ...
                            i3 = CompilationStatus.RESULT_CODE_ERROR_CANT_WRITE_PROFILE_VERIFICATION_RESULT_CACHE_FILE;
                        }
                    }
