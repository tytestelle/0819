...
class Encoding {
    ...
    public static byte[] read(@NonNull InputStream inputStream, int i) throws IOException {
        ...
        while (i2 < i) {
            ...
            if (i3 < 0) {
                throw error(O000000oOo0oOOOOoO0ooooo0oOOoO00Oo0Oo000.O0000000Oo0o0O00ooOooooooO0000Oo0oO0O0oO.O000000o0ooOOOOoO0OO0000OOOoo0oo0OOOOoo0(i, "Not enough bytes to read: "));
            }
            i2 += i3;
        }
        return bArr;
