...
class RequestExecutor {
    ...
    public static ThreadPoolExecutor createDefaultExecutor(@NonNull String str, int i, @IntRange(from = MediaDescriptionCompat.BT_FOLDER_TYPE_MIXED) int i2) {
    ...
    public static <T> T submit(@NonNull ExecutorService executorService, @NonNull Callable<T> callable, @IntRange(from = MediaDescriptionCompat.BT_FOLDER_TYPE_MIXED) int i) throws InterruptedException {
        try {
