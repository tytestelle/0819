...
public class FontsContractCompat {
    ...
    public static class FontInfo {
        ...
        public static FontInfo create(@NonNull Uri uri, @IntRange(from = MediaDescriptionCompat.BT_FOLDER_TYPE_MIXED) int i, @IntRange(from = 1, to = 1000) int i2, boolean z, int i3) {
    ...
    @Nullable
    @RestrictTo({RestrictTo.Scope.LIBRARY})
    public static Typeface requestFont(@NonNull Context context, @NonNull FontRequest fontRequest, int i, boolean z, @IntRange(from = MediaDescriptionCompat.BT_FOLDER_TYPE_MIXED) int i2, @NonNull Handler handler, @NonNull FontRequestCallback fontRequestCallback) {
