...
public final class MimeTypeFilter {
    ...
    public static boolean matches(@Nullable String str, @NonNull String str2) {
        ...
        return mimeTypeAgainstFilter(str.split(ServiceReference.DELIMITER), str2.split(ServiceReference.DELIMITER));
    }
    ...
    public static String[] matchesMany(@Nullable String[] strArr, @NonNull String str) {
        ...
        for (String str2 : strArr) {
            if (mimeTypeAgainstFilter(str2.split(ServiceReference.DELIMITER), strArrSplit)) {
                arrayList.add(str2);
            }
        }
    ...
    public static String matches(@Nullable String str, @NonNull String[] strArr) {
        ...
        String[] strArrSplit = str.split(ServiceReference.DELIMITER);
        for (String str2 : strArr) {
            if (mimeTypeAgainstFilter(strArrSplit, str2.split(ServiceReference.DELIMITER))) {
                return str2;
            }
        }
        return null;
