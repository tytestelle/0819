...
public final class TextViewCompat {
    ...
    public static void setFirstBaselineToTopHeight(@NonNull TextView textView, @IntRange(from = MediaDescriptionCompat.BT_FOLDER_TYPE_MIXED) @Px int i) {
    ...
    public static void setLastBaselineToBottomHeight(@NonNull TextView textView, @IntRange(from = MediaDescriptionCompat.BT_FOLDER_TYPE_MIXED) @Px int i) {
        Preconditions.checkArgumentNonnegative(i);
        Paint.FontMetricsInt fontMetricsInt = textView.getPaint().getFontMetricsInt();
    ...
    public static void setLineHeight(@NonNull TextView textView, @IntRange(from = MediaDescriptionCompat.BT_FOLDER_TYPE_MIXED) @Px int i) {
        Preconditions.checkArgumentNonnegative(i);
