...
public class ActivityCompat extends ContextCompat {
    ...
    public static class SharedElementCallback21Impl extends android.app.SharedElementCallback {
        ...
        public void onSharedElementsArrived(List<String> list, List<View> list2, final android.app.SharedElementCallback.OnSharedElementsReadyListener onSharedElementsReadyListener) {
            this.mCallback.onSharedElementsArrived(list, list2, new SharedElementCallback.OnSharedElementsReadyListener() { // from class: androidx.core.app.O000000O000O00O0oOOo0o0oooO0oO0oOO00OooO
    ...
    public static boolean isLaunchedFromBubble(@NonNull Activity activity) {
        ...
        return (i != 29 || activity.getWindowManager().getDefaultDisplay() == null || activity.getWindowManager().getDefaultDisplay().getDisplayId() == 0) ? false : true;
    }
    ...
    public static void recreate(@NonNull final Activity activity) {
        if (Build.VERSION.SDK_INT >= 28) {
            ...
            new Handler(activity.getMainLooper()).post(new Runnable() { // from class: androidx.core.app.O0000000Oo0o0O00ooOooooooO0000Oo0oO0O0oO
    ...
    public static void requestPermissions(@NonNull final Activity activity, @NonNull String[] strArr, @IntRange(from = MediaDescriptionCompat.BT_FOLDER_TYPE_MIXED) final int i) {
        PermissionCompatDelegate permissionCompatDelegate = sDelegate;
        if (permissionCompatDelegate == null || !permissionCompatDelegate.requestPermissions(activity, strArr, i)) {
            HashSet hashSet = new HashSet();
            for (int i2 = 0; i2 < strArr.length; i2++) {
                if (TextUtils.isEmpty(strArr[i2])) {
                    throw new IllegalArgumentException(O000000oOo0oOOOOoO0ooooo0oOOoO00Oo0Oo000.O0000000Oo0o0O00ooOooooooO0000Oo0oO0O0oO.O00000OO000O000Oo0000oOOo0OO0oOoo0o0oo00(new StringBuilder("Permission request for permissions "), Arrays.toString(strArr), " must not contain null or empty values"));
                }
