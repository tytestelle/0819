...
public class NotificationChannelGroupCompat {
    ...
    private List<NotificationChannelCompat> getChannelsCompat(List<NotificationChannel> list) {
        ...
        while (it.hasNext()) {
            ...
            if (this.mId.equals(Api26Impl.getGroup(notificationChannelO000000OoooOoo0Ooo0OO00o00oOOo0O0ooooO0o))) {
                arrayList.add(new NotificationChannelCompat(notificationChannelO000000OoooOoo0Ooo0OO00o00oOOo0O0ooooO0o));
            }
        }
        return arrayList;
    }
