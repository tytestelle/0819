...
public class ExifInterface {
        ...
        public void skipFully(int i) throws IOException {
            ...
            while (i2 < i) {
                ...
                if (iSkip <= 0) {
                    ...
                    if (iSkip == -1) {
                        throw new EOFException(O0000000Oo0o0O00ooOooooooO0000Oo0oO0O0oO.O000000oO0OOo0O00OoooOOoOO0o0o0000O0OOoO(i, "Reached EOF while skipping ", " bytes."));
                    }
                }
                i2 += iSkip;
            }
    ...
    public static class ExifAttribute {
        ...
        public String toString() {
            ...
            return O0000000Oo0o0O00ooOooooooO0000Oo0oO0O0oO.O00000O00oOOo000000OOOo00OOOo0OooOO00OO0(sb, ")", this.bytes.length);
        }
    ...
    public static class Rational {
        ...
        public String toString() {
            return this.numerator + ServiceReference.DELIMITER + this.denominator;
        }
    ...
    private static double convertRationalLatLonToDouble(String str, String str2) {
        try {
            ...
            String[] strArrSplit2 = strArrSplit[0].split(ServiceReference.DELIMITER, -1);
            double d = Double.parseDouble(strArrSplit2[0].trim()) / Double.parseDouble(strArrSplit2[1].trim());
            String[] strArrSplit3 = strArrSplit[1].split(ServiceReference.DELIMITER, -1);
            double d2 = Double.parseDouble(strArrSplit3[0].trim()) / Double.parseDouble(strArrSplit3[1].trim());
            String[] strArrSplit4 = strArrSplit[2].split(ServiceReference.DELIMITER, -1);
    ...
    /* JADX WARN: Code duplicated, block: B:63:0x0172 A[LOOP:0: B:10:0x0034->B:63:0x0172, LOOP_END] */
    /* JADX WARN: Code duplicated, block: B:81:0x0179 A[SYNTHETIC] */
    /*  JADX ERROR: UnsupportedOperationException in pass: RegionMakerVisitor
        ...
        */
    private void getJpegAttributes(androidx.exifinterface.media.ExifInterface.ByteOrderedDataInputStream in, int offsetToJpeg, int imageType) throws java.lang.Throwable {
        // Restored from the corresponding AndroidX ExifInterface JPEG parser.
        if (DEBUG) {
            Log.d(TAG, "getJpegAttributes starting with: " + in);
        }
        in.setByteOrder(ByteOrder.BIG_ENDIAN);
        in.seek(offsetToJpeg);
        int bytesRead = offsetToJpeg;
        byte marker;
        ...
        while (true) {
            ...
            switch (marker) {
                case MARKER_APP1: {
                    if (length >= 6) {
                        ...
                        if (Arrays.equals(identifier, IDENTIFIER_EXIF_APP1)) {
                            ...
                            setThumbnailData(new ByteOrderedDataInputStream(bytes));
                        }
                    }
                    break;
                }
                ...
                case MARKER_SOF15: {
                    ...
                    in.skipFully(1);
                    mAttributes[imageType].put(TAG_IMAGE_LENGTH,
                            ExifAttribute.createULong(in.readUnsignedShort(), mExifByteOrder));
                    mAttributes[imageType].put(TAG_IMAGE_WIDTH,
                            ExifAttribute.createULong(in.readUnsignedShort(), mExifByteOrder));
                    length -= 5;
                    break;
                }
    ...
    private static Pair<Integer, Integer> guessDataFormat(String str) {
        ...
        String[] strArrSplit2 = str.split(ServiceReference.DELIMITER, -1);
    ...
    private void parseTiffHeaders(ByteOrderedDataInputStream byteOrderedDataInputStream) throws IOException {
        ...
        int i2 = byteOrderedDataInputStream.readInt();
        if (i2 < 8) {
            throw new IOException(O0000000Oo0o0O00ooOooooooO0000Oo0oO0O0oO.O000000o0ooOOOOoO0OO0000OOOoo0oo0OOOOoo0(i2, "Invalid first Ifd offset: "));
        }
        int i3 = i2 - 8;
        if (i3 > 0) {
    ...
    private void printAttributes() {
        for (int i = 0; i < this.mAttributes.length; i++) {
            StringBuilder sbO00000OOoOOoOOOo00oo0000O00ooo0oO00O00oO = O0000000Oo0o0O00ooOooooooO0000Oo0oO0O0oO.O00000OOoOOoOOOo00oo0000O00ooo0oO00O00oO(i, "The size of tag group[", "]: ");
            sbO00000OOoOOoOOOo00oo0000O00ooo0oO00O00oO.append(this.mAttributes[i].size());
            Log.d(TAG, sbO00000OOoOOoOOOo00oo0000O00ooo0oO00O00oO.toString());
    ...
    /* JADX WARN: Code duplicated, block: B:100:0x0268 A[DONT_INVERT] */
    /* JADX WARN: Code duplicated, block: B:101:0x026a  */
    /* JADX WARN: Code duplicated, block: B:103:0x0281  */
    /* JADX WARN: Code duplicated, block: B:105:0x02b4  */
    ...
    /* JADX WARN: Code duplicated, block: B:120:0x02f9  */
    ...
    /* JADX WARN: Code duplicated, block: B:77:0x01e8 A[DONT_INVERT] */
    ...
    /* JADX WARN: Code duplicated, block: B:99:0x0249  */
    /* JADX WARN: Instruction removed from duplicated block: B:101:0x026a, please report this as an issue */
    /* JADX WARN: Instruction removed from duplicated block: B:52:0x013a, please report this as an issue */
    /* JADX WARN: Instruction removed from duplicated block: B:69:0x01c0, please report this as an issue */
    /* JADX WARN: Instruction removed from duplicated block: B:99:0x0249, please report this as an issue */
    private void readImageFileDirectory(SeekableByteOrderedDataInputStream seekableByteOrderedDataInputStream, int i) throws IOException {
        ...
        String str2 = TAG;
        if (z2) {
            Log.d(TAG, "numberOfDirectoryEntry: " + ((int) s2));
        }
        if (s2 <= 0) {
            return;
        }
        ...
        while (s3 < s2) {
            ...
            if (z3) {
                ...
                String str3 = exifTag != null ? exifTag.name : null;
            ...
            if (exifTag != null) {
                if (unsignedShort3 > 0) {
                    ...
                    if (unsignedShort3 < iArr.length) {
                        if (exifTag.isFormatCompatible(unsignedShort3)) {
                            ...
                            if (j < 0 || j > 2147483647L) {
                                if (z3) {
                                    Log.d(str2, "Skip the tag entry since the number of components is invalid: " + i4);
                                }
                                z = false;
                            } else {
                                z = true;
                    ...
                    if (z) {
                        if (j > 4) {
                            ...
                            if (z3) {
                                Log.d(str2, "seek to data offset: " + i2);
                            }
                            if (this.mMimeType == 7) {
                        ...
                        if (z3) {
                            str = str2;
                            Log.d(str, "nextIfdType: " + num + " byteCount: " + j);
                        } else {
                            str = str2;
                        }
                        if (num != null) {
                ...
                s = s3;
                if (z3) {
                    Log.d(str2, "Skip the tag entry since data format is invalid: " + unsignedShort3);
                }
                z = false;
                j = 0;
                if (z) {
        ...
        boolean z4 = DEBUG;
        if (z4) {
            Log.d(str4, String.format("nextIfdOffset: %d", Integer.valueOf(i5)));
        }
        long j3 = i5;
        if (j3 <= 0) {
            if (z4) {
                Log.d(str4, "Stop reading file since a wrong offset may cause an infinite loop: " + i5);
                return;
            }
            return;
        }
        if (this.mAttributesOffsets.contains(Integer.valueOf(i5))) {
            if (z4) {
                Log.d(str4, "Stop reading file since re-reading an IFD may cause an infinite loop: " + i5);
                return;
            }
            return;
        }
    ...
    public byte[] getThumbnailBytes() throws Throwable {
        ...
        try {
            if (this.mAssetInputStream != null) {
                if (!this.mAssetInputStream.markSupported()) {
                    Log.d(TAG, "Cannot read thumbnail from inputstream without mark/reset support");
                    return null;
                }
                this.mAssetInputStream.reset();
                input = this.mAssetInputStream;
            } else if (this.mFilename != null) {
                input = new FileInputStream(this.mFilename);
            } else if (this.mSeekableFileDescriptor != null) {
                fd = ExifInterfaceUtils.Api21Impl.dup(this.mSeekableFileDescriptor);
                ExifInterfaceUtils.Api21Impl.lseek(fd, 0L, OsConstants.SEEK_SET);
                input = new FileInputStream(fd);
            } else {
                return null;
            }
            long skip = this.mThumbnailOffset + this.mOffsetToExifData;
            long skipped = 0L;
            while (skipped < skip) {
                long n = input.skip(skip - skipped);
                if (n <= 0) throw new IOException("Corrupted image");
                skipped += n;
            }
            byte[] bytes = new byte[this.mThumbnailLength];
            int offset = 0;
            ...
            this.mThumbnailBytes = bytes;
            return bytes;
        } catch (Exception e) {
            Log.d(TAG, "Encountered exception while getting thumbnail", e);
            return null;
        } finally {
            if (input != null && input != this.mAssetInputStream) {
                ExifInterfaceUtils.closeQuietly(input);
            }
            if (fd != null) {
                ExifInterfaceUtils.closeFileDescriptor(fd);
            }
        }
    }
                    ...
                    if (exifTag.primaryFormat == ((Integer) pairGuessDataFormat.first).intValue() || exifTag.primaryFormat == ((Integer) pairGuessDataFormat.second).intValue()) {
                        ...
                        if (i6 == -1 || !(i6 == ((Integer) pairGuessDataFormat.first).intValue() || exifTag.secondaryFormat == ((Integer) pairGuessDataFormat.second).intValue())) {
                            ...
                            if (i7 == i3 || i7 == 7 || i7 == i2) {
                                ...
                                StringBuilder sbO00000oO00OOooo000ooOOoOoOO0Oo0oOOOOoooo = O0000000Oo0o0O00ooOooooooO0000Oo0oO0O0oO.O00000oO00OOooo000ooOOoOoOO0Oo0oOOOOoooo("Given tag (", str3, ") value didn't match with one of expected formats: ");
                                String[] strArr = IFD_FORMAT_NAMES;
                                sbO00000oO00OOooo000ooOOoOoOO0Oo0oOOOOoooo.append(strArr[exifTag.primaryFormat]);
                                sbO00000oO00OOooo000ooOOoOoOO0Oo0oOOOOoooo.append(exifTag.secondaryFormat == -1 ? "" : ", " + strArr[exifTag.secondaryFormat]);
                                sbO00000oO00OOooo000ooOOoOoOO0Oo0oOOOOoooo.append(" (guess: ");
                                sbO00000oO00OOooo000ooOOoOoOO0Oo0oOOOOoooo.append(strArr[((Integer) pairGuessDataFormat.first).intValue()]);
                                sbO00000oO00OOooo000ooOOoOoOO0Oo0oOOOOoooo.append(((Integer) pairGuessDataFormat.second).intValue() != -1 ? ", " + strArr[((Integer) pairGuessDataFormat.second).intValue()] : "");
                    ...
                    switch (i) {
                        ...
                        case 5:
                            ...
                            while (i10 < strArrSplit3.length) {
                                String[] strArrSplit4 = strArrSplit3[i10].split(ServiceReference.DELIMITER, i5);
                        ...
                        case 10:
                            ...
                            while (i12 < strArrSplit6.length) {
                                String[] strArrSplit7 = strArrSplit6[i12].split(ServiceReference.DELIMITER, -1);
    ...
    public void setDateTime(@NonNull Long l) {
        ...
        for (int length = string.length(); length < 3; length++) {
            string = O0000000Oo0o0O00ooOooooooO0000Oo0oO0O0oO.O00000oo0O0Oo0OO0oOoOoOOOOoOOoo0oOoOOOoO(SessionDescription.SUPPORTED_SDP_VERSION, string);
        }
