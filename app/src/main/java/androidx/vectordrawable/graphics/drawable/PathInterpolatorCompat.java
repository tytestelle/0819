...
public class PathInterpolatorCompat implements Interpolator {
    ...
    private void parseInterpolatorFromTypeArray(TypedArray typedArray, XmlPullParser xmlPullParser) {
        if (TypedArrayUtils.hasAttribute(xmlPullParser, "pathData")) {
            ...
            if (pathCreatePathFromPathData == null) {
                throw new InflateException(O0000000Oo0o0O00ooOooooooO0000Oo0oO0O0oO.O00000oo0O0Oo0OO0oOoOoOOOOoOOoo0oOoOOOoO("The path is null, which is created from ", namedString));
            }
    ...
    public float getInterpolation(float f) {
        ...
        float[] fArr2 = this.mY;
        float f6 = fArr2[i];
        return O0000000Oo0o0O00ooOooooooO0000Oo0oO0O0oO.O0000000Oo0o0O00ooOooooooO0000Oo0oO0O0oO(fArr2[length], f6, f5, f6);
    }
