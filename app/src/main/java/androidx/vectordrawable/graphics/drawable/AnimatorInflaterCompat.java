...
public class AnimatorInflaterCompat {
    ...
    private static void dumpKeyframes(Object[] objArr, String str) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            StringBuilder sbO00000OOoOOoOOOo00oo0000O00ooo0oO00O00oO = O0000000Oo0o0O00ooOooooooO0000Oo0oO0O0oO.O00000OOoOOoOOOo00oo0000O00ooo0oO00O00oO(i, "Keyframe ", ": fraction ");
            Object value = "null";
            sbO00000OOoOOoOOOo00oo0000O00ooo0oO00O00oO.append(keyframe.getFraction() < 0.0f ? "null" : Float.valueOf(keyframe.getFraction()));
            sbO00000OOoOOoOOOo00oo0000O00ooo0oO00O00oO.append(", , value : ");
    ...
    private static Keyframe loadKeyframe(Context context, Resources resources, Resources.Theme theme, AttributeSet attributeSet, int i, XmlPullParser xmlPullParser) {
        ...
        TypedArray typedArrayObtainAttributes = TypedArrayUtils.obtainAttributes(resources, theme, attributeSet, AndroidResources.STYLEABLE_KEYFRAME);
        float namedFloat = TypedArrayUtils.getNamedFloat(typedArrayObtainAttributes, xmlPullParser, O000000oOo0oOOOOoO0ooooo0oOOoO00Oo0Oo000.FRACTION, 3, -1.0f);
        TypedValue typedValuePeekNamedValue = TypedArrayUtils.peekNamedValue(typedArrayObtainAttributes, xmlPullParser, "value", 0);
