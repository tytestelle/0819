...
public class Direct {
    ...
    /* JADX WARN: Code duplicated, block: B:114:0x01e4 A[DONT_INVERT] */
    /* JADX WARN: Code duplicated, block: B:115:0x01e6 A[DONT_INVERT] */
    /* JADX WARN: Code duplicated, block: B:116:0x01e8 A[DONT_INVERT] */
    /* JADX WARN: Code duplicated, block: B:117:0x01ea  */
    /* JADX WARN: Code duplicated, block: B:118:0x020b  */
    /* JADX WARN: Code duplicated, block: B:120:0x022c A[RETURN] */
    /* JADX WARN: Code duplicated, block: B:122:0x022e A[ORIG_RETURN, RETURN] */
    ...
    /* JADX WARN: Code duplicated, block: B:88:0x0152 A[DONT_INVERT] */
    ...
    public static boolean solveChain(ConstraintWidgetContainer constraintWidgetContainer, LinearSystem linearSystem, int i, int i2, ChainHead chainHead, boolean z, boolean z2, boolean z3) {
        ...
        ConstraintAnchor constraintAnchor3 = first.mListAnchors[i2];
        int i5 = i2 + 1;
        ConstraintAnchor constraintAnchor4 = last.mListAnchors[i5];
        ...
        int margin3 = firstVisibleWidget.mListAnchors[i2].getMargin() + constraintAnchor3.mTarget.getFinalValue();
        int finalValue = constraintAnchor4.mTarget.getFinalValue() - lastVisibleWidget.mListAnchors[i5].getMargin();
        ...
        while (true) {
            ...
            if (z6) {
                ...
                if (!z) {
                    ...
                    while (!z4) {
                        ...
                        constraintWidget.addToSolver(linearSystem, z5);
                        constraintAnchor = constraintWidget.mListAnchors[i5].mTarget;
                        if (constraintAnchor != null) {
                            constraintWidget2 = constraintAnchor.mOwner;
                            constraintAnchor2 = constraintWidget2.mListAnchors[i2].mTarget;
            ...
            ConstraintAnchor constraintAnchor6 = constraintWidget3.mListAnchors[i5].mTarget;
            if (constraintAnchor6 != null) {
                ConstraintWidget constraintWidget7 = constraintAnchor6.mOwner;
                ConstraintAnchor constraintAnchor7 = constraintWidget7.mListAnchors[i2].mTarget;
