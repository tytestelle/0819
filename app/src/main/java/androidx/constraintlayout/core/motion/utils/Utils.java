...
public class Utils {
    ...
    public static void logStack(String str, int i) {
        ...
        for (int i2 = 1; i2 <= iMin; i2++) {
            ...
            String str2 = ".(" + stackTrace[i2].getFileName() + ":" + stackTrace[i2].getLineNumber() + ") " + stackTrace[i2].getMethodName();
            strO000000ooOO0oOoOo00OoooOOo0OO00o0000o0oO = O000000oOo0oOOOOoO0ooooo0oOOoO00Oo0Oo000.O0000000Oo0o0O00ooOooooooO0000Oo0oO0O0oO.O000000ooOO0oOoOo00OoooOOo0OO00o0000o0oO(strO000000ooOO0oOoOo00OoooOOo0OO00o0000o0oO, " ");
