...
public class ConstraintSet {
    ...
    public class WriteXmlEngine {
        ...
        private void writeEnum(String str, int i, String[] strArr, int i2) throws IOException {
            if (i != i2) {
                ...
                StringBuilder sbO00000oO00OOooo000ooOOoOoOO0Oo0oOOOOoooo = O0000000Oo0o0O00ooOooooooO0000Oo0oO0O0oO.O00000oO00OOooo000ooOOoOoOO0Oo0oOOOOoooo(SPACE, str, "=\"");
                sbO00000oO00OOooo000ooOOoOoOO0Oo0oOOOOoooo.append(strArr[i]);
                sbO00000oO00OOooo000ooOOoOoOO0Oo0oOOOOoooo.append("\"");
                writer.write(sbO00000oO00OOooo000ooOOoOoOO0Oo0oOOOOoooo.toString());
            }
        }

        public String getName(int i) {
            if (this.idMap.containsKey(Integer.valueOf(i))) {
                return O0000000Oo0o0O00ooOooooooO0000Oo0oO0O0oO.O00000OO000O000Oo0000oOOo0OO0oOoo0o0oo00(new StringBuilder("@+id/"), this.idMap.get(Integer.valueOf(i)), "");
            }
            if (i == 0) {
            ...
            switch (mapToConstant.get(index)) {
                ...
                case 86:
                    ...
                    if (i2 == 1) {
                        ...
                        if (constraint.motion.mQuantizeInterpolatorString.indexOf(ServiceReference.DELIMITER) > 0) {
                            constraint.motion.mQuantizeInterpolatorID = typedArray.getResourceId(index, -1);
        ...
        switch (i2) {
            case 1:
                if (i4 == 1) {
                    ...
                    if (i4 != 2) {
                        throw new IllegalArgumentException(O0000000Oo0o0O00ooOooooooO0000Oo0oO0O0oO.O00000OO000O000Oo0000oOOo0OO0oOoo0o0oo00(new StringBuilder("Left to "), sideToString(i4), " undefined"));
                    }
                    Layout layout2 = constraint.layout;
            ...
            case 2:
                if (i4 == 1) {
                    ...
                    if (i4 != 2) {
                        throw new IllegalArgumentException(O0000000Oo0o0O00ooOooooooO0000Oo0oO0O0oO.O00000OO000O000Oo0000oOOo0OO0oOoo0o0oo00(new StringBuilder("right to "), sideToString(i4), " undefined"));
                    }
                    Layout layout4 = constraint.layout;
            ...
            default:
                ...
                sb.append(" to ");
                throw new IllegalArgumentException(O0000000Oo0o0O00ooOooooooO0000Oo0oO0O0oO.O00000OO000O000Oo0000oOOo0OO0oOoo0o0oo00(sb, sideToString(i4), " unknown"));
        }
    }
    ...
    public void clone(ConstraintSet constraintSet) {
        ...
        for (Integer num : constraintSet.mConstraints.keySet()) {
            Constraint constraint = constraintSet.mConstraints.get(num);
            if (constraint != null) {
                this.mConstraints.put(num, constraint.m39clone());
            }
        }
    }
    ...
    public class WriteJsonEngine {
        ...
        public String getName(int i) {
            if (this.idMap.containsKey(Integer.valueOf(i))) {
                return O0000000Oo0o0O00ooOooooooO0000Oo0oO0O0oO.O00000OO000O000Oo0000oOOo0OO0oOoo0o0oo00(new StringBuilder("'"), this.idMap.get(Integer.valueOf(i)), "'");
            }
            if (i == 0) {
                return "'parent'";
            }
