...
public class ConstraintAttribute {
    ...
    public static void setAttributes(View view, HashMap<String, ConstraintAttribute> map) {
        ...
        for (String str : map.keySet()) {
            ConstraintAttribute constraintAttribute = map.get(str);
            String strO00000oo0O0Oo0OO0oOoOoOOOOoOOoo0oOoOOOoO = !constraintAttribute.mMethod ? O0000000Oo0o0O00ooOooooooO0000Oo0oO0O0oO.O00000oo0O0Oo0OO0oOoOoOOOOoOOoo0oOoOOOoO("set", str) : str;
            try {
                switch (AnonymousClass1.$SwitchMap$androidx$constraintlayout$widget$ConstraintAttribute$AttributeType[constraintAttribute.mType.ordinal()]) {
                    case 1:
                        cls.getMethod(strO00000oo0O0Oo0OO0oOoOoOOOOoOOoo0oOoOOOoO, Integer.TYPE).invoke(view, Integer.valueOf(constraintAttribute.mIntegerValue));
                        break;
                    case 2:
                        cls.getMethod(strO00000oo0O0Oo0OO0oOoOoOOOOoOOoo0oOoOOOoO, Boolean.TYPE).invoke(view, Boolean.valueOf(constraintAttribute.mBooleanValue));
                        break;
                    case 3:
                        cls.getMethod(strO00000oo0O0Oo0OO0oOoOoOOOOoOOoo0oOoOOOoO, CharSequence.class).invoke(view, constraintAttribute.mStringValue);
                        break;
                    case 4:
                        cls.getMethod(strO00000oo0O0Oo0OO0oOoOoOOOOoOOoo0oOoOOOoO, Integer.TYPE).invoke(view, Integer.valueOf(constraintAttribute.mColorValue));
                        break;
                    case 5:
                        Method method = cls.getMethod(strO00000oo0O0Oo0OO0oOoOoOOOOoOOoo0oOoOOOoO, Drawable.class);
                    ...
                    case 6:
                        ...
                        break;
                    case 7:
                        cls.getMethod(strO00000oo0O0Oo0OO0oOoOoOOOOoOOoo0oOoOOOoO, Float.TYPE).invoke(view, Float.valueOf(constraintAttribute.mFloatValue));
                        break;
                    case 8:
                        cls.getMethod(strO00000oo0O0Oo0OO0oOoOoOOOOoOOoo0oOoOOOoO, Float.TYPE).invoke(view, Float.valueOf(constraintAttribute.mFloatValue));
                        break;
                ...
                StringBuilder sbO00000oO00OOooo000ooOOoOoOO0Oo0oOOOOoooo = O0000000Oo0o0O00ooOooooooO0000Oo0oO0O0oO.O00000oO00OOooo000ooOOoOoOO0Oo0oOOOOoooo(" Custom Attribute \"", str, "\" not found on ");
                ...
                Log.e(TAG, cls.getName() + " must have a method " + strO00000oo0O0Oo0OO0oOoOoOOOOoOOoo0oOoOOOoO);
            } catch (InvocationTargetException e3) {
                StringBuilder sbO00000oO00OOooo000ooOOoOoOO0Oo0oOOOOoooo2 = O0000000Oo0o0O00ooOooooooO0000Oo0oO0O0oO.O00000oO00OOooo000ooOOoOoOO0Oo0oOOOOoooo(" Custom Attribute \"", str, "\" not found on ");
                sbO00000oO00OOooo000ooOOoOoOO0Oo0oOOOOoooo2.append(cls.getName());
    ...
    public void applyCustom(View view) {
        ...
        String strO00000oo0O0Oo0OO0oOoOoOOOOoOOoo0oOoOOOoO = !this.mMethod ? O0000000Oo0o0O00ooOooooooO0000Oo0oO0O0oO.O00000oo0O0Oo0OO0oOoOoOOOOoOOoo0oOoOOOoO("set", str) : str;
        try {
            switch (AnonymousClass1.$SwitchMap$androidx$constraintlayout$widget$ConstraintAttribute$AttributeType[this.mType.ordinal()]) {
                case 1:
                case 6:
                    cls.getMethod(strO00000oo0O0Oo0OO0oOoOoOOOOoOOoo0oOoOOOoO, Integer.TYPE).invoke(view, Integer.valueOf(this.mIntegerValue));
                    break;
                case 2:
                    cls.getMethod(strO00000oo0O0Oo0OO0oOoOoOOOOoOOoo0oOoOOOoO, Boolean.TYPE).invoke(view, Boolean.valueOf(this.mBooleanValue));
                    break;
                case 3:
                    cls.getMethod(strO00000oo0O0Oo0OO0oOoOoOOOOoOOoo0oOoOOOoO, CharSequence.class).invoke(view, this.mStringValue);
                    break;
                case 4:
                    cls.getMethod(strO00000oo0O0Oo0OO0oOoOoOOOOoOOoo0oOoOOOoO, Integer.TYPE).invoke(view, Integer.valueOf(this.mColorValue));
                    break;
                case 5:
                    Method method = cls.getMethod(strO00000oo0O0Oo0OO0oOoOoOOOOoOOoo0oOoOOOoO, Drawable.class);
                    ColorDrawable colorDrawable = new ColorDrawable();
                    ...
                    break;
                case 7:
                    cls.getMethod(strO00000oo0O0Oo0OO0oOoOoOOOOoOOoo0oOoOOOoO, Float.TYPE).invoke(view, Float.valueOf(this.mFloatValue));
                    break;
                case 8:
                    cls.getMethod(strO00000oo0O0Oo0OO0oOoOoOOOOoOOoo0oOoOOOoO, Float.TYPE).invoke(view, Float.valueOf(this.mFloatValue));
                    break;
