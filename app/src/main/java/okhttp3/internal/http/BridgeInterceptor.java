...
public final class BridgeInterceptor implements Interceptor {
    ...
    public Response intercept(Interceptor.Chain chain) {
        ...
        if (request.header(O0000000Oo0o0O00ooOooooooO0000Oo0oO0O0oO.HEAD_KEY_ACCEPT_ENCODING) == null && request.header("Range") == null) {
            builderNewBuilder.header(O0000000Oo0o0O00ooOooooooO0000Oo0oO0O0oO.HEAD_KEY_ACCEPT_ENCODING, "gzip");
            z = true;
        }
        List<Cookie> listLoadForRequest = this.cookieJar.loadForRequest(request.url());
        if (!listLoadForRequest.isEmpty()) {
            builderNewBuilder.header(O0000000Oo0o0O00ooOooooooO0000Oo0oO0O0oO.HEAD_KEY_COOKIE, cookieHeader(listLoadForRequest));
        }
