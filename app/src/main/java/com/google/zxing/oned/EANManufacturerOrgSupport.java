...
final class EANManufacturerOrgSupport {
    ...
    private synchronized void initIfNeeded() {
        if (this.ranges.isEmpty()) {
            ...
            add(new int[]{385}, "HR");
            add(new int[]{387}, "BA");
            add(new int[]{TbsListener.ErrorCode.INFO_CODE_BASE, 440}, "DE");
            ...
            add(new int[]{TbsListener.ErrorCode.INFO_CODE_MINIQB, 509}, "GB");
            add(new int[]{520}, "GR");
            ...
            add(new int[]{628}, "SA");
            add(new int[]{629}, "AE");
            add(new int[]{TbsListener.ErrorCode.STATIC_TBS_INSTALL_MAKE_SYMBOLIC_LINK_ERR, 649}, "FI");
            add(new int[]{TbsListener.ErrorCode.STATIC_TBS_INSTALL_API_LEVEL_MISMATCH, 695}, "CN");
