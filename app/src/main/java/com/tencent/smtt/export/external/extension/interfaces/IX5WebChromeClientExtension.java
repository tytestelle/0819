...
public interface IX5WebChromeClientExtension {
    ...
    void onAllMetaDataFinished(IX5WebViewExtension iX5WebViewExtension, HashMap<String, String> map);
    ...
    void onPrepareX5ReadPageDataFinished(IX5WebViewExtension iX5WebViewExtension, HashMap<String, String> map);
    ...
    void onX5ReadModeAvailableChecked(HashMap<String, String> map);
