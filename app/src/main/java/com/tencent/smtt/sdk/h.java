...
class h extends X5ProxyWebChromeClient {
    ...
    public boolean onCreateWindow(IX5WebViewBase iX5WebViewBase, boolean z, boolean z2, final Message message) {
        ...
        webView.getClass();
        final WebView.WebViewTransport webViewTransport = webView.new WebViewTransport();
        Message messageObtain = Message.obtain(message.getTarget(), new Runnable() { // from class: com.tencent.smtt.sdk.h.1
        ...
        return this.b.onCreateWindow(this.a, z, z2, messageObtain);
    }
