...
public class TbsConfig {
    ...
    public static final boolean BUSINESS_BUILD = false;
    ...
    public static final boolean TBS_READER_MODE = false;
    public static final String TBS_SDK_VERSIONNAME = "4.3.0.386";
