...
public class a {
    ...
    private static void a(int[] iArr, int i2, int i3, int[][] iArr2) {
        ...
        while (i10 < 8) {
            for (int i11 = 0; i11 < 6; i11++) {
                iArr8[i10][i11] = iArr7[(i10 * 6) + i11];
            }
            int[][] iArr12 = l[i10];
            int[] iArr13 = iArr8[i10];
            iArr9[i10] = iArr12[(iArr13[0] << 1) + iArr13[5]][(iArr13[1] << 3) + (iArr13[2] << 2) + (iArr13[3] << 1) + iArr13[4]];
            for (int i12 = 0; i12 < 4; i12++) {
                iArr10[((i10 * 4) + 3) - i12] = iArr9[i10] % 2;
    ...
    private static int[] a(byte[] bArr) {
        ...
        for (int i2 = 0; i2 < 8; i2++) {
            ...
            iArr[i2] = b2;
            if (b2 < 0) {
                int i3 = b2 + MdtaMetadataEntry.AUXILIARY_TRACKS_SAMPLES_NOT_INTERLEAVED;
                iArr[i2] = i3;
                iArr[i2] = i3 % 256;
            }
        }
